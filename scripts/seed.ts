...
const seedTx = db.transaction(() => {
  ...
  const vaultOffers: {
  ...
  }[] = [
    {
      ...
      partnerName: "Bait Al Luban Omani Restaurant – Mutrah",
      category: "RESTAURANT",
      city: "Mutrah, Muscat",
      icon: "🍽️",
      discountPercent: 25,
    ...
    },
    {
      ...
      partnerName: "Ramssa Omani Restaurant",
      category: "RESTAURANT",
      city: "Muscat",
      icon: "🍛",
      discountPercent: 20,
      coinCost: 6,
      description: "Home-style Omani cooking in a relaxed, family-friendly setting.",
    },
    {
      offerId: "VAULT-000003",
      partnerName: "Rozna Restaurant",
      category: "RESTAURANT",
      city: "Muscat",
      icon: "🍲",
      discountPercent: 50,
      coinCost: 70,
      description: "An elevated fine-dining take on traditional Omani cuisine — this Vault's top restaurant tier.",
    },
    {
      offerId: "VAULT-000004",
      partnerName: "Aroos Al Bahar Fish Restaurant",
      category: "RESTAURANT",
      city: "Muscat",
      icon: "🦞",
      discountPercent: 30,
      coinCost: 12,
      description: "Fresh catch-of-the-day seafood dining overlooking the Gulf of Oman.",
    },
    {
      offerId: "VAULT-000005",
      partnerName: "Takara Muscat",
      category: "RESTAURANT",
      city: "Muscat",
      icon: "🍣",
      discountPercent: 35,
      coinCost: 15,
      description: "Contemporary Japanese dining and a sushi bar in the heart of Muscat.",
    },
    {
      offerId: "VAULT-000006",
      partnerName: "The Chedi Muscat",
      category: "HOTEL",
      city: "Muscat",
      icon: "🏨",
      discountPercent: 20,
      coinCost: 100,
      description: "Serene beachfront luxury stays with award-winning pools and spa.",
    },
    {
      offerId: "VAULT-000007",
      partnerName: "Al Bustan Palace, a Ritz-Carlton Hotel",
      category: "HOTEL",
      city: "Muscat",
      icon: "🏰",
      discountPercent: 20,
      coinCost: 110,
      description: "An iconic palatial resort set between the Al Hajar Mountains and the Gulf of Oman.",
    },
    {
      offerId: "VAULT-000008",
      partnerName: "Six Senses Zighy Bay",
      category: "HOTEL",
      city: "Musandam",
      icon: "🏖️",
      discountPercent: 25,
      coinCost: 120,
      description: "Secluded pool-villa resort on a private bay in the Musandam peninsula.",
    },
    {
      offerId: "VAULT-000009",
      partnerName: "The St. Regis Al Mouj Muscat Resort",
      category: "HOTEL",
      city: "Muscat",
      icon: "🏝️",
      discountPercent: 20,
      coinCost: 105,
      description: "Signature St. Regis butler service on Al Mouj's marina waterfront.",
    },
    {
      offerId: "VAULT-000010",
      partnerName: "Anantara Al Jabal Al Akhdar Resort",
      category: "HOTEL",
      city: "Jabal Akhdar",
      icon: "🏔️",
      discountPercent: 25,
      coinCost: 115,
      description: "Clifftop luxury resort perched 2,000 meters up Oman's Green Mountain.",
    },
    {
